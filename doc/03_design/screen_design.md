...
- URL：`/profile`
- 説明：運営者の自己紹介を表示
- 主な表示項目：作者アイコン、表示名、肩書き、SNSリンク（X・GitHub）、プロフィール本文、競馬のスタンス、好きな競馬場・レース・券種、サイト概要、免責
...
| 2026-08-23 | 2.8 | プロフィールの表示項目に作者アイコン・SNSリンクを追加 | βshort |
| 2026-08-23 | 2.9 | プロフィールに肩書き・スタンス・好み・免責を追加 | βshort |
